...
# run googleapi
osascript -e 'tell application "Terminal" to do script "cd /Users/Luckman/Documents/SJSU/Course/2016_Fall/272/Final_Project/Fall16-Team6/SmartIDE/GoogleAPI_DatParser/GoogleAPI; python googleapi.py"'
